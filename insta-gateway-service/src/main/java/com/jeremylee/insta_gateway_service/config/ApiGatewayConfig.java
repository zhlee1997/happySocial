...
//                can be URL of microservices
        ...
        Function<PredicateSpec, Buildable<Route>> routeMedia
                = p -> p.path("/hello/**")
...
//                lb -> and load balancing between instances which are returned
        ...
        Function<PredicateSpec, Buildable<Route>> routePost
                = p -> p.path("/post/**")
//                currency-exchange -> talk to Eureka, find the location of this service
//                lb -> and load balancing between instances which are returned
                .filters(gatewayFilterSpec -> gatewayFilterSpec.filter(filter))
        ...
        Function<PredicateSpec, Buildable<Route>> routeUser
                = p -> p.path("/user/**")
//                currency-exchange -> talk to Eureka, find the location of this service
//                lb -> and load balancing between instances which are returned
                .filters(gatewayFilterSpec -> gatewayFilterSpec.filter(filter))
        ...
        Function<PredicateSpec, Buildable<Route>> routeAuth
                = p -> p.path("/auth/**")
//                currency-exchange -> talk to Eureka, find the location of this service
//                lb -> and load balancing between instances which are returned
                .filters(gatewayFilterSpec -> gatewayFilterSpec.filter(filter))
